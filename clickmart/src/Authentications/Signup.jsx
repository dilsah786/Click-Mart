...
const Signup = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen ">
      <div className="flex flex-col lg:flex-row md:flex-row justify-center items-center border p-4 gap-4 shadow-xl mt-64 lg:mt-4 md:mt-4">
        <div>
          <img
            src={bgImage}
      ...
      <button className="text-blue-600 underline"><Link to="/login"> Login here </Link> </button>
      </div>
    </div>
  );
};
